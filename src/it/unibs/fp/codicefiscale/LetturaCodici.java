...
public class LetturaCodici {
	...
	/**
	 * 
	 * legge tutti i codici ed in base al valore in input restituisce un arraylist
	 * di codici giusti o sbagliati inserisci treu per avere quelli corretti false
	 * per avere quelli sbagliati
	 * 
	 * @return
